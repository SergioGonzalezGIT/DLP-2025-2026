...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		CHAR_CONSTANT=45, ID=46, COMMENT_UNALINEA=47, COMMENT_VARIASLINEAS=48, 
		WHITESPACES=49;
	public static final int
		...
		RULE_statement = 12, RULE_caseRule = 13, RULE_block = 14, RULE_expression = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"statement", "caseRule", "block", "expression"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'='", "'while'", "'if'", "'else'", "'return'", "'log'", "'input'", "'switch'", 
			"'default'", "'case'", "'.'", "'as'", "'-'", "'!'", "'*'", "'%'", "'/'", 
			"'+'", "'>'", "'>='", "'<'", "'<='", "'!='", "'=='", "'&&'", "'||'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CHAR_CONSTANT", "ID", "COMMENT_UNALINEA", "COMMENT_VARIASLINEAS", "WHITESPACES"
		};
	}
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131943038189632L) != 0)) {
				{
				{
				setState(94);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131943005945920L) != 0)) {
					{
					setState(255);
					((StatementContext)_localctx).ex1 = expression(0);
			...
			case 8:
				...
				{
				setState(270);
				((StatementContext)_localctx).OP = match(T__23);
				setState(271);
				match(T__5);
				setState(272);
				...
				while (_la==T__25) {
					...
					{
					setState(276);
					((StatementContext)_localctx).c = caseRule();
					 cases.add(((StatementContext)_localctx).c.ast); 
					}
					}
					setState(283);
					_errHandler.sync(this);
				...
				if (_la==T__24) {
					...
					while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131943038189632L) != 0)) {
						...
						((StatementContext)_localctx).s = statement();
						 defStmts.add(((StatementContext)_localctx).s.ast); 
						}
						}
						setState(293);
						_errHandler.sync(this);
				...
				setState(296);
				match(T__8);
				 ((StatementContext)_localctx).ast =  new Switch(((StatementContext)_localctx).OP.getLine(), ((StatementContext)_localctx).OP.getCharPositionInLine() + 1, ((StatementContext)_localctx).e.ast, cases, defStmts); 
				}
				break;
			}
		}
	...
	public final CaseRuleContext caseRule() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_caseRule);
		...
		try {
			...
			{
			setState(301);
			((CaseRuleContext)_localctx).OP = match(T__25);
			setState(302);
			((CaseRuleContext)_localctx).e = expression(0);
			setState(303);
			match(T__2);
			setState(309);
			_errHandler.sync(this);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131943038189632L) != 0)) {
				...
				{
				setState(304);
				((CaseRuleContext)_localctx).s = statement();
				 stmts.add(((CaseRuleContext)_localctx).s.ast); 
				}
				}
				setState(311);
				_errHandler.sync(this);
			 ...
			 ((CaseRuleContext)_localctx).ast =  new Case(((CaseRuleContext)_localctx).OP.getLine(), ((CaseRuleContext)_localctx).OP.getCharPositionInLine() + 1, ((CaseRuleContext)_localctx).e.ast, stmts); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
