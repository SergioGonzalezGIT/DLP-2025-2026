...
public class TSmmParser extends Parser {
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32985775341632L) != 0)) {
				{
				{
				setState(92);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				setState(237);
				match(T__3);
				 ((StatementContext)_localctx).ast =  new Incremento((((StatementContext)_localctx).exp!=null?(((StatementContext)_localctx).exp.start):null).getLine(), (((StatementContext)_localctx).exp!=null?(((StatementContext)_localctx).exp.start):null).getCharPositionInLine() + 1, ((StatementContext)_localctx).exp.ast); 
				}
				break;
			case 7:
